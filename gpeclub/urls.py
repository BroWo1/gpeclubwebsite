...
urlpatterns = [
    ...
    path('projects/vocab/sets_data/<str:set_name>/', views.vocab_set_data, name='vocabSetData'),    path('agent/upload_pdf/', views.upload_pdf_to_openai, name='agent_upload_pdf'),
